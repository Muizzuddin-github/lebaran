...
export default function Home() {
  ...
  return <>
      ...
      <header className='bg-biru p-5 h-screen flex flex-col items-center dark:bg-biru-dark'>
        ...
        <section className='max-w-xl text-white text-center mt-4'>
          <h1 className='text-3xl mb-1'>Idul Fitri Center</h1>
          <p className='text-xl leading-6'>Idul Fitri Center adalah sebuah layanan untuk menyimpan daftar kunjungan anda selama hari raya idul fitri</p>
      ...
      <main className='dark:bg-biru-dark pt-14 dark:text-white pb-28'>
        <article className='max-w-xl p-2 text-center m-auto'>
            ...
            <p className='text-lg leading-6'>kami menyediakan layanan untuk menyimpan daftar kunjungan anda, idul fitri center memberikan 3 fitur utama </p>
          </article>
