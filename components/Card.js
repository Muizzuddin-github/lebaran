    ...
    return ( 
        <section className="card shadow-kunjungan m-5 relative rounded-md py-6 px-10 text-xl hover:shadow-kunjungan-hover hover:scale-105 transition-all ease-linear lg:px-20 lg:pl-10">
            <ul className="mb-5 dark:text-white">
                ...
                <li className="mb-2">Nama <p className="ml-5 mr-2 inline-block">:</p>{orang.kunjungan.nama}</li>
                <li  className="mb-2">Alamat <p className="ml-3 mr-2 inline-block">:</p>{orang.kunjungan.alamat}</li>
                <li>No HP <p className="ml-4 mr-2 inline-block">:</p>{orang.kunjungan.noHP}</li>
            </ul>
            <button className="ubah py-1 px-4 bg-biru hover:bg-biru-hover rounded-md text-lg text-white mr-1" onClick={ubah}>ubah</button>
            <button className="detil py-1 px-4 bg-biru hover:bg-biru-hover rounded-md text-lg text-white ml-1" onClick={() => detilHapus('.detil-kunjungan')}>detil</button>
        </section>
     );
}
