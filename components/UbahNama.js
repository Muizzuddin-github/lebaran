...
const UbahNama = ({setName}) => {
    ...
    return ( 
        <form className="ubah-nama -translate-x-[200%] opacity-0 transition-all duration-300 mx-20 sm:mx-48 md:mx-64 lg:mx-0 px-10 py-6 fixed z-30 bg-white right-0 left-0 lg:left-1/3 top-1/3 lg:right-1/3 rounded text-xl dark:text-white dark:bg-biru-dark dark:shadow-popup">
            <h1 className="text-xl mb-3">Ubah Nama</h1>
            <section className="flex justify-between items-center p-1 text-lg">
            ...
            <p className="text-abu-abu mt-7 text-lg">ubah nama?</p>
